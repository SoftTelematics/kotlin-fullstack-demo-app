...
public class JFlywaySchemaHistory implements Serializable {

    private static final long serialVersionUID = -1410153747;
    ...
    public JFlywaySchemaHistory(JFlywaySchemaHistory value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JFlywaySchemaHistory (");
